#!/usr/bin/env python3
"""Compare May 18 load test run vs Apr 1 leaky (unfixed) run: full dashboard."""
...
RUNS = [
    ...
    (os.path.join(BASE, "local_monitoring_20260401_132347"), "Apr 1 Leaky"),
]
...
def plot_memory_cpu():
    ...
    fig.suptitle(
        "May 18 vs Apr 1 Leaky — Memory & CPU per Service",
    ...
    plt.tight_layout()
    out = os.path.join(BASE, "may18_vs_leaky_memory_cpu.png")
...
def plot_rss_broker():
    ...
    fig, axes = plt.subplots(3, 2, figsize=(16, 12))
    fig.suptitle(
        "May 18 vs Apr 1 Leaky — Process RSS & Broker Dicts",
        fontsize=15, fontweight="bold",
    )
    ...
    plt.tight_layout()
    out = os.path.join(BASE, "may18_vs_leaky_rss_broker.png")
    plt.savefig(out, dpi=150)
    print(f"Saved: {out}")
    plt.close()
...
def plot_memory_detail():
    ...
    fig.suptitle("CCX Memory Monitoring — May 18 vs Apr 1 Leaky", fontsize=16, fontweight="bold")
    ...
    plt.tight_layout()
    out = os.path.join(BASE, "may18_vs_leaky_memory_detail.png")
    plt.savefig(out, dpi=150)
    print(f"Saved: {out}")
    plt.close()
...
def plot_prometheus_detail():
    ...
    fig, axes = plt.subplots(3, 2, figsize=(18, 14), sharex="col")
    fig.suptitle("CCX Prometheus Metrics — May 18 vs Apr 1 Leaky", fontsize=16, fontweight="bold")
    ...
    plt.tight_layout()
    out = os.path.join(BASE, "may18_vs_leaky_prometheus_detail.png")
    plt.savefig(out, dpi=150)
    print(f"Saved: {out}")
    plt.close()
...
def plot_gc_stats():
    ...
    fig, axes = plt.subplots(3, 2, figsize=(18, 14), sharex="col")
    fig.suptitle("CCX GC Stats — May 18 vs Apr 1 Leaky", fontsize=16, fontweight="bold")
    ...
    plt.tight_layout()
    out = os.path.join(BASE, "may18_vs_leaky_gc_stats.png")
    plt.savefig(out, dpi=150)
    print(f"Saved: {out}")
    plt.close()
